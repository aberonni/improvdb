...
export default function TermsPage() {
  return (
    <>
      <Head>
        <title>Terms of Service - ImprovDB</title>
      </Head>
      <PageLayout
      ...
      >
        <p>
          Throughout this statement and this website, the terms “we”, “us” and
          “our” refer to the operator of this website.
        </p>
        ...
        <p>
          ...
          Credit card information is not transferred to our website, but may be
          transferred to a third party PCI-compliant payment processor such as
          PayPal, DPS, SecurePay and others. Credit card information is always
          encrypted during transfer to any payment processor.
        </p>
        ...
        <h3>Section 2 - Online Store Terms</h3>
        ...
        <h3>Section 4 - Modifications to the Service or Prices</h3>
        ...
        <p>
          ...
          Return Policy found elsewhere on this website.
        </p>
        ...
        <p>
          Your submission of personal information through any form, email or the
          store is governed by our Privacy Policy found elsewhere on this
          website.
        </p>
        ...
        <p>
          In no case shall ImprovDB, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless ImprovDB and our
        ...
        <p>
          ...
          laws of the country that the operator of this website resides in.
        </p>
